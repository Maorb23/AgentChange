...
class ModelDerivedChangeSummary(BaseModel):
    source: Literal["generated_by_codex_from_observed_git_diff"] = (
        "generated_by_codex_from_observed_git_diff"
    )
    source_label: Literal["Generated by Codex from the observed Git diff."] = (
        "Generated by Codex from the observed Git diff."
    )
    status: Literal["provided", "not_provided", "invalid"]
...
class Receipt(BaseModel):
    ...
    model_derived_change_summary: ModelDerivedChangeSummary
